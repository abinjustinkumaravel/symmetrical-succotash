...
const PROJECTS: Project[] = [
  {
    ...
    desc: "Secure single-tenant enterprise AI knowledge engine. Qwen2.5-3B quantized to Q4_K_M GGUF for 10–18 tok/s CPU inference. Hybrid BM25 + dense vector retrieval with 3-layer security: local license middleware, JWT auth, and pre-retrieval ACL filters.",
  ...
  },
  {
    ...
    desc: "Advanced retrieval pipeline combining parallel BM25 keyword search and dense vector retrieval (BAAI/bge-m3, 1024-dim). Reciprocal Rank Fusion (k=60) fused with a BGE-Reranker-Base cross-encoder to eliminate latency bottlenecks and maximise precision.",
  ...
  },
  {
    ...
    desc: "Local computer vision pipeline for real-time asset tracking. YOLOv8 inference on live feeds with NumPy and Pandas preprocessing of raw detection logs — structured bounding box metadata extraction for downstream analytics.",
